...
interface FormalLanguagesMCQProps {
    theme?: Theme;
    onThemeChange?: (theme: Theme) => void;
}

export default function FormalLanguagesMCQ({ theme = 'emerald', onThemeChange = () => { } }: FormalLanguagesMCQProps) {
    const { user } = useAuth();
    ...
    const fetchQuestions = async (selectedMode: 'practice' | 'test', unit?: string) => {
        ...
        try {
            ...
            const res = await fetch(`/fla_questions.json?t=${Date.now()}`);
