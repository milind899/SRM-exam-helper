...
export const examContent: Unit[] = [
    ...
    {
        id: "unit-5",
        title: "UNIT 5 – GRAPH + CODING THEORY",
        sections: [
            {
                title: "Important Topics",
                items: [
                    { id: "u5-it-1", text: "Kruskal MST" },
                    { id: "u5-it-2", text: "Warshall closure" },
                    { id: "u5-it-3", text: "generator matrix → codewords" },
                    { id: "u5-it-4", text: "parity matrix" },
                    { id: "u5-it-5", text: "decoding messages" },
                    { id: "u5-it-6", text: "Hamming distance" },
                ]
            },
            {
                title: "Repeated Questions",
                items: [
                    { id: "u5-rep-1", text: "Find MST using Kruskal’s algorithm", isRepeated: true, year: "May 2024, Jan 2024..." },
                    { id: "u5-rep-2", text: "Find transitive closure using Warshall for R={(1,2)...}", isRepeated: true },
                    { id: "u5-rep-3", text: "Find code words generated by parity check matrix H", isRepeated: true },
                    { id: "u5-rep-4", text: "Find code words by generator matrix G and decode", isRepeated: true },
                    { id: "u5-rep-5", text: "Find minimum distance between codes x and y", isRepeated: true },
                ]
            },
            {
                title: "Revision",
                items: [
                    { id: "u5-rev-1", text: "Solve 1 MST problem" },
                    { id: "u5-rev-2", text: "Solve 1 Warshall problem" },
                    { id: "u5-rev-3", text: "Solve 1 Coding Theory problem" },
                ]
            }
        ]
    }
